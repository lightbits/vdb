...
// necessary files included in vdb.cpp
#if 0
#include "imgui.h"
...
// my old machine does not have this symbol defined
#ifndef GL_SAMPLER_BINDING
typedef void (*PFNGLBINDSAMPLERPROC)(GLuint unit, GLuint sampler);
PFNGLBINDSAMPLERPROC glBindSampler = NULL;
#define GL_SAMPLER_BINDING GL_CULL_FACE // just an arbitrary valid enum for glGetInteger below
#endif
