...
void vdbGetFramebufferSize(int *width, int *height);
int  vdbGetFramebufferWidth();
int  vdbGetFramebufferHeight();
float vdbGetFramebufferAspect();
...
bool vdbKeyPressed(vdbKey key);
bool vdbKeyDown(vdbKey key);
bool vdbKeyReleased(vdbKey key);
bool vdbMouseLeftPressed();
bool vdbMouseLeftDown();
bool vdbMouseLeftReleased();
bool vdbMouseRightPressed();
bool vdbMouseRightDown();
bool vdbMouseRightReleased();
bool vdbMouseMiddlePressed();
bool vdbMouseMiddleDown();
bool vdbMouseMiddleReleased();
float vdbMouseWheel();
